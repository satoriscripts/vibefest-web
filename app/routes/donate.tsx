...
export default function DonatePage() {
  ...
  return (
    <Container>
      ...
      <p>
        We are currently raising money for 4 different causes this volume. The
        Trevor Project, The Robinson Malawi Fund, The Colon Cancer Coalition,
        and a special VIBEFEST fund to help one of our staff/artists get a new
        computer!
      </p>
      <p>
